package com.ranindu.rstore.models;
...
public class ProductDto {
    ...
    @Size(max = 2000,message = "The description cannot exceed 2000 charactors")
    ...
    public @Size(min = 10, message = "The description should be at least 10 characters") @Size(max = 2000, message = "The description cannot exceed 2000 charactors") String getDescription() {
        return description;
    }

    public void setDescription(@Size(min = 10, message = "The description should be at least 10 characters") @Size(max = 2000, message = "The description cannot exceed 2000 charactors") String description) {
